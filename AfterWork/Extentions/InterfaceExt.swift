...
class InterfaceExt {
  ...
  func frameTextView(text: String, font: UIFont, lineHeightMultiple: CGFloat) -> UITextView {
    ...
    if lineHeightMultiple !=
      0 { textView.setLineSpacing(lineSpacing: 1, lineHeightMultiple: lineHeightMultiple) }
  ...
  func card(fromData data: [Any]) -> SwipeCard {
    ...
    let content = DI.shared.getInterfaceExt().basicCard(
      type: data[1] as! String,
      title: data[2] as! String,
      description: data[6] as! String,
      workHours: data[10] as! String,
      bill: data[8] as! Int,
      isRecommended: data[7] as! Bool
    )
  ...
  func basicCard(
    ...
    let typeText = frameTextView(
      text: type,
      font: .boldSystemFont(ofSize: 16),
      lineHeightMultiple: 0.5
    )
    let nameText = frameTextView(
      text: title,
      font: UIFont(name: "Helvetica Neue Condensed Black", size: 36)!,
      lineHeightMultiple: 0.7
    )
    let descriptionText = frameTextView(
      text: description,
    ...
    let workHouseTitle = frameTextView(
      text: "Часы работы",
      font: .boldSystemFont(ofSize: 28),
      lineHeightMultiple: 0.6
    )
    let workHouseText = frameTextView(
      text: workHours,
      font: UIFont(name: "Helvetica Neue Medium", size: 14)!,
      lineHeightMultiple: 0.5
    )

    let billTitle = frameTextView(
      text: "Средний чек",
      font: .boldSystemFont(ofSize: 28),
      lineHeightMultiple: 0.6
    )
    ...
    let constraintsArray = [
      typeTextConstraints,
      nameTextConstraints,
      viewRectangleConstraints,
      hideRectangleConstraints,
      descriptionTextConstraints,
      workHouseTitleConstraints,
      workHouseTextConstraints,
      billTitleConstraints,
      billPriceConstraints,
    ].flatMap { $0 }
