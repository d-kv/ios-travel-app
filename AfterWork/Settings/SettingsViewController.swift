...
class SettingsViewController: UIViewController {
  ...
  let signOutButton = interfaceExt.lightGreyButton(
    title: "Выйти из аккаунта",
    color: UIColor(named: "LightGrayColor")!
  )

  let resetRecommendButton = interfaceExt.lightGreyButton(
    title: "Сбросить рекомендации",
    color: UIColor(named: "LightGrayColor")!
  )
  let adminButton = interfaceExt.lightGreyButton(
    title: "Админ-панель",
    color: UIColor(named: "LightGrayColor")!
  )
